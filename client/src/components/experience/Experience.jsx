...
export default function Experience() {
  ...
  const data = [
    ...
    },
    {
      ...
      desc:
        "Wrote >30 lessons for K-12 students about air pollution, the energy-water nexus, and other environmental topics for the PEAK Project. Researched background information for teachers about climate literacy, waste management, and water. Wrote, edited, and researched data for training manuals on saving energy for San Diego employees.",
      img:
        "../assets/anlon-tec.jpeg",
    },
    {
      id: "3",
      ...
      desc:
        "Quantified the energy potentials of wind power and photovoltaics for every country across the globe. Used GIS and mathematical models. Projected the levelized cost of electricity and burden of each renewable energy technology.",
      img:
        "../assets/RE-Research.png",
    },
    {
    id: "4",
    ...
    },
    {
      id: "5",
        ...
        desc:
          "Sustainability and entrepreneurship program. I learned from lectures and breakout discussions on a huge variety of research: half-Earth project, Flint Water Crisis, cotton supply chain, etc. Our team also won an energy crisis simulation with a coal to hydropower transition. Our capstone project group researched a pinpoint policy solution to livestock waste management.",
        img:
          "../assets/yygs-speak-side-2.jpg",
      },
  ];
